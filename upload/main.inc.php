...
/*
 * TODO: Modificar pacotes pear para atualiza-los
...
if (!db_connect(DBHOST,DBUSER,DBPASS) || !db_select_database(DBNAME)) {
    ...
    $ferror=_('Short open tag disabled! - osTicket requires it turned ON.');
}

if($ferror) { //Fatal error
    Sys::alertAdmin('osTicket Fatal Error',$ferror); //try alerting admin.
    die("<b>" . _("Fatal Error:") . "</b> " . _("Contact system adminstrator.")); //Generic error.
    exit;
}
//Init
$cfg->init();
