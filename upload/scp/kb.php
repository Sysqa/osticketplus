...
if (!$thisuser->canManageKb() && !$thisuser->isadmin())
    die(_('Access Denied'));
...
$nav->addSubMenu(array('desc' => _('Premade Replies'), 'href' => 'kb.php', 'iconclass' => 'premade'));
$nav->addSubMenu(array('desc' => _('New Premade Reply'), 'href' => 'kb.php?a=add', 'iconclass' => 'newPremade'));
