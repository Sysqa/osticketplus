<? if(!defined('OSTSCPINC') || !is_object($thisuser) || !$thisuser->isStaff() || !is_object($nav)) die(_('Access Denied')); ?>
<html>
<head>
...
<div id="container">
    <div id="header">
        ...
        <p id="info"><?= _('Welcome back') ?>, <strong><?=$thisuser->getUsername()?></strong>
           <?php
            ...
            <?}?>
            | <a href="profile.php?t=pref"><?= _('My Preference') ?></a> | <a href="logout.php"><?= _('Log Out') ?></a></p>
    </div>
    <div id="nav">
