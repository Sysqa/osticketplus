<?php
if(!defined('OSTSCPINC') || !is_object($ticket) || !is_object($thisuser) || !$thisuser->isStaff()) die(_('Access Denied'));
...
<table width="100%" border="0" cellspacing=1 cellpadding=2>
  <form action="tickets.php?id=<?=$ticket->getId()?>" method="post">
    ...
    <tr><td align="left" colspan=2 class="msg">
            <?= _('Update Ticket #') ?><?=$ticket->getExtId()?>&nbsp;&nbsp;(<a href="tickets.php?id=<?=$ticket->getId()?>" style="color:black;"><?= _('View Ticket') ?></a>)<br></td></tr>
    <tr>
    ...
    <tr>
        <td align="left" valign="top"><b><?= _('Internal Note:') ?></b></td>
        <td>
