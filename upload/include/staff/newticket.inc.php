<?php
if(!defined('OSTSCPINC') || !is_object($thisuser) || !$thisuser->isStaff()) die(_('Access Denied'));
...
<table width="80%" border="0" cellspacing=1 cellpadding=2>
   <form action="tickets.php" method="post" enctype="multipart/form-data">
    ...
    <tr>
        <td align="left" valign="top"><b><?= _('Issue Summary:') ?></b></td>
        <td>
            <i><?= _('Visible to client/customer.') ?></i><font class="error"><b>*&nbsp;<?=$errors['issue']?></b></font><br/>
            <?
            ...
            <?= _('Premade:') ?>&nbsp;
              <select id="canned" name="canned"
                onChange="getCannedResponse(this.options[this.selectedIndex].value,this.form,'issue');this.selectedIndex='0';" >
                  <option value="0" selected="selected"><?= _('Select a premade reply/issue') ?></option>
    ...
    <?}?>
    <tr>
        <td align="left" valign="top"><?= _('Internal Note:') ?></td>
        <td>
    ...
    <tr>
        <td align="left" valign="top"><?= _('Due Date:') ?></td>
        <td>
    ...
    <tr>
        <td align="left" valign="top"><?= _('Help Topic:') ?></td>
        <td>
            <select name="topicId">
