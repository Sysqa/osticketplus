<?php
if (!defined('OSTSCPINC') or !is_object($thisuser) or !$thisuser->canManageKb())
    die(_('Access Denied'));
...
$results_type = ($search) ? _('Search Results') : _('Premade/Canned Replies');
        ...
        <tr><td>
                <table border="0" cellspacing=0 cellpadding=2 class="dtable" align="center" width="100%">
                    <tr>
                        <th width="7px">&nbsp;</th>
                        <th>
                            <a href="kb.php?sort=title&order=<?= $negorder ?><?= $qstr ?>" title="<?= _('Sort By Title') ?> <?= $negorder ?>"><?= _('Reply Title') ?></a></th>
                        <th width=50><?= _('Status') ?></th>
                        <th width=200><?= _('Category/Dept') ?></th>
                        <th width=150 nowrap>
                            <a href="kb.php?sort=updatedate&order=<?= $negorder ?><?= $qstr ?>" title="<?= _('Sort By Update Date') ?> <?= $negorder ?>"><?= _('Last Updated') ?></a></th>
                    </tr>
                    <?
                    $class = 'row1';
                    $total = 0;
