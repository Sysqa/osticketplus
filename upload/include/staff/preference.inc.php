...
?>
<div class="msg"><?= _('System Preferences and Settings') ?>&nbsp;&nbsp;(v<?=$config['ostversion']?>)</div>
...
<table width="100%" border="0" cellspacing=0 cellpadding=0>
 <tr><td>
    ...
    <table width="100%" border="0" cellspacing=0 cellpadding=2 class="tform">
        ...
        <tr><th valign="top"><?= _('Ticket IDs:') ?></th>
            <td>
        ...
        <tr><th valign="top"><?= _('Ticket Priority:') ?></th>
            <td>
    ...
    <table width="100%" border="0" cellspacing=0 cellpadding=2 class="tform">
        ...
        <tr><th valign="top"><br><b><?= _('Incoming Emails') ?></b>:</th>
        ...
        <tr><th valign="top"><br><b><?= _('Outgoing Emails') ?></b>:</th>
            <td>
        ...
        <tr><th valign="top"><?= _('Default Alert Email:') ?></th>
            <td>
        ...
        <tr><th><?= _('System Admin Email Address:') ?></th>
            <td>
    ...
    <table width="100%" border="0" cellspacing=0 cellpadding=2 class="tform">
        ...
        <tr><th valign="top"><?= _('New Ticket by Staff:') ?></th>
        ...
        <tr><th valign="top"><?= _('New Message:') ?></th>
        ...
        <tr><th valign="top"><?= _('Overlimit notice:') ?></th>
            <td><i><?= _('Ticket denied notice sent <b>only once</b> on limit violation to the user.') ?></i><br/>
                ...
                <br><i><?= _('<b>Note:</b> Admin gets alerts on ALL denials by default.') ?></i><br>
            </td>
        </tr>
    </table>
    <table width="100%" border="0" cellspacing=0 cellpadding=2 class="tform">
        <tr class="header"><td colspan=2>&nbsp;<?= _('Alerts &amp; Notices') ?></td></tr>
        <tr class="subheader"><td colspan=2>
                <?= _('Notices sent to user use \'No Reply Email\' whereas alerts to staff use \'Alert Email\' set above as FROM address respectively.') ?></td>
        </tr>
        <tr><th valign="top"><?= _('New Ticket Alert:') ?></th>
            <td>
                ...
                <input type="checkbox" name="ticket_alert_admin" <?=$config['ticket_alert_admin']?'checked':''?>> <?= _('Admin Email') ?>
        ...
        <tr><th valign="top"><?= _('New Message Alert:') ?></th>
            <td>
              ...
              <input type="checkbox" name="message_alert_dept_manager" <?=$config['message_alert_dept_manager']?'checked':''?>> <?= _('Department Manager (spammy)') ?>
            </td>
        </tr>
        <tr><th valign="top"><?= _('New Internal Note Alert:') ?></th>
            <td>
              ...
              <input type="checkbox" name="note_alert_dept_manager" <?=$config['note_alert_dept_manager']?'checked':''?>> <?= _('Department Manager (spammy)') ?>
            </td>
        </tr>
        <tr><th valign="top"><?= _('Overdue Ticket Alert:') ?></th>
            <td>
              ...
              <br><i><?= _('Admin Email gets an alert by default. Select additional recipients below') ?></i>&nbsp;<font class="error">&nbsp;<?=$errors['overdue_alert_active']?></font><br>
        ...
        <tr><th valign="top"><?= _('System Errors:') ?></th>
            <td><i><?= _('Enabled errors are sent to admin email set above') ?></i><br>
