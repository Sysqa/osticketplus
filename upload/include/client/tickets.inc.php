<?php
if(!defined('OSTCLIENTINC') || !is_object($thisclient) || !$thisclient->isValid()) die(_('Kwaheri rafiki!'));
 ...
 <table width="100%" border="0" cellspacing=0 cellpadding=2>
    <tr><td>
     <table border="0" cellspacing=0 cellpadding=2 class="tgrid" align="center">
        <tr>
	        <th width="70" nowrap>
                <a href="view.php?sort=ID&order=<?=$negorder?><?=$qstr?>" title="<?= _('Sort By Ticket ID')?> <?=$negorder?>"><?= _('Ticket #')?></a></th>
	        <th width="100">
                <a href="view.php?sort=date&order=<?=$negorder?><?=$qstr?>" title="<?= _('Sort By Date')?> <?=$negorder?>"><?= _('Create Date')?></a></th>
            <th width="60"><?= _('Status')?></th>
            <th width="240"><?= _('Subject')?></th>
            <th width="150">
                <a href="view.php?sort=dept&order=<?=$negorder?><?=$qstr?>" title="<?= _('Sort By Category')?> <?=$negorder?>"><?= _('Department')?></a></th>
            <th width="150"><?= _('Email')?></th>
        </tr>
        <?
        $class = "row1";
        $total=0;
